...
public class Commando {
    ...
    public static void printTable(String TableName) {
        ...
        JDBC_Connection(printQuery, "aim", "Samisasi$9804");
    }
    ...
    public static void DeleteFood(String ConditionTuple, int Quantity) {
        ...
        Connection c = null;
        try {
            c = DriverManager.getConnection("jdbc:mysql://localhost:3306/aim", "root", "Samisasi$9804");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public static boolean SearchByFoodItem(String food_item_name) {
        ...
        ResultSet r = JDBC(Query, "aim", "Samisasi$9804");
        try {
            if (!r.next())
                Flag = false;
        } catch (SQLException e) {
    ...
    public static boolean SearchByPartialString(String str) {
        ...
        ResultSet r1 = JDBC(Q1, "aim", "Samisasi$9804");
        ResultSet r2 = JDBC(Q2, "aim", "Samisasi$9804");
        ResultSet r3 = JDBC(Q3, "aim", "Samisasi$9804");
        try {
    ...
    public static void SearchByQuantity(int Number) {
        ...
        r1 = JDBC(Query, "aim", "Samisasi$9804");
        JDBC_Connection(Query, "aim", "Samisasi$9804");

        String Query1 = "Select * from Clothes where Quantity <= " + Number;
        r2 = JDBC(Query1, "aim", "Samisasi$9804");
        JDBC_Connection(Query1, "aim", "Samisasi$9804");
        String Query2 = "Select * from Ammunitions where Quantity <= " + Number;
        r3 = JDBC(Query2, "aim", "Samisasi$9804");
        JDBC_Connection(Query2, "aim", "Samisasi$9804");
        try {
            if (!(r1.next() || r2.next() || r3.next()))
