...
public class PrintTables {
    ...
    public void P_Tables() throws SQLException {
        ...
        ResultSet r = Tables.JDBC("SELECT * FROM Authentication", "aim", "Samisasi$9804");
        ...
        r = Tables.JDBC("SELECT * FROM bomb", "aim", "Samisasi$9804");
        ...
        r = Tables.JDBC("SELECT * FROM Food ", "aim", "Samisasi$9804");
        ...
        r = Tables.JDBC("SELECT * FROM Clothes ", "aim", "Samisasi$9804");
        ...
        r = Tables.JDBC("SELECT * FROM Ammunitions ", "aim", "Samisasi$9804");
